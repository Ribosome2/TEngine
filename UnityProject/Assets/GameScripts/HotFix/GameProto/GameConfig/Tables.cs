...
public partial class Tables
{
    ...
    private kyle.TbKyleItem m_TbKyleItem;
    public kyle.TbKyleItem TbKyleItem 
    {
        get
        {
            if (m_TbKyleItem == null)
            {
                m_TbKyleItem = new kyle.TbKyleItem(defaultLoader("kyle_tbkyleitem"));
                m_TbKyleItem.ResolveRef(this);
            }
            return m_TbKyleItem;
        }
        set
